# VAULT_MK2_backend.py (Ping Düzeltmesi)
...
print("VAULT MK2 Yerel Komut Çekirdeği Başlatılıyor...")
...
LOCAL_COMMANDS = {
    "chrome'u aç": open_chrome,
    "google'ı aç": open_chrome,
    "not defterini aç": open_notepad,
...
# YENİ: Bağlantı kontrolü için özel ping adresi
...
@app.route('/')
def serve_frontend():
    return send_from_directory('.', 'VAULT_MK2_frontend.html')

# --- Sunucuyu Başlat ---
if __name__ == '__main__':
    print("V.A.U.L.T. MK2 tüm sistemleri aktif etti. Arayüz http://127.0.0.1:5000 adresinde hazır.")
